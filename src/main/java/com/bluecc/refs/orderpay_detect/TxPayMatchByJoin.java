package com.bluecc.refs.orderpay_detect;

import com.bluecc.refs.orderpay_detect.beans.OrderEvent;
import com.bluecc.refs.orderpay_detect.beans.OrderResult;
import com.bluecc.refs.orderpay_detect.beans.ReceiptEvent;
...
//        URL orderResource = TxPayMatchByJoin.class.getResource("/OrderLog.csv");
        DataStream<OrderEvent> orderEventStream = env.readTextFile("dataset/OrderLog.csv")
                .map(line -> {
...
//        URL receiptResource = TxPayMatchByJoin.class.getResource("/ReceiptLog.csv");
        SingleOutputStreamOperator<ReceiptEvent> receiptEventStream = env.readTextFile("dataset/ReceiptLog.csv")
                .map(line -> {
                    String[] fields = line.split(",");
