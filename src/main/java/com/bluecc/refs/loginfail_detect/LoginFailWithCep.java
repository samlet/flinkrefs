package com.bluecc.refs.loginfail_detect;

import com.bluecc.refs.loginfail_detect.beans.*;
...
//        URL resource = LoginFailWithCep.class.getResource("/LoginLog.csv");
        DataStream<LoginEvent> loginEventStream = env.readTextFile("dataset/LoginLog.csv")
                .map(line -> {
