package com.bluecc.refs.networkflow_analysis;

import com.bluecc.refs.networkflow_analysis.beans.*;
...
//        URL resource = UniqueVisitor.class.getResource("/UserBehavior.csv");
        DataStream<String> inputStream = env.readTextFile("dataset/UserBehavior.csv");
