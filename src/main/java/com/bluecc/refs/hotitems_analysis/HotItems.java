...
import com.bluecc.refs.hotitems_analysis.beans.ItemViewCount;
...
/**
 * $ just run hotitems_analysis.HotItems -topic hot
 * $ just run hotitems_analysis.KafkaProducerUtil -topic hot
 */
...
//        DataStream<String> inputStream = env.readTextFile("D:\\Projects\\BigData\\UserBehaviorAnalysis\\HotItemsAnalysis\\src\\main\\resources\\UserBehavior.csv");
        ...
        DataStream<String> inputStream = env.addSource(new FlinkKafkaConsumer<String>(topic, new SimpleStringSchema(), properties));
