...
package com.bluecc.refs.user_behavior.generator;
...
/*
$ just create user_behavior
$ just run user_behavior.generator.SourceGenerator --input dataset/user_behavior.log \
    --output kafka localhost:9092 --speedup 2000
$ just consume user_behavior
 */
public class SourceGenerator {
    ...
    public static void main(String[] args) {
        File userBehaviorFile = new File("dataset/user_behavior.log");
        long speed = SPEED;
        ...
        System.out.println(".. generate from line "+startLine);
