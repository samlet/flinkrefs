package com.bluecc.refs.market_analysis;

import com.bluecc.refs.market_analysis.beans.*;
...
//        URL resource = AdStatisticsByProvince.class.getResource("/AdClickLog.csv");
        DataStream<AdClickEvent> adClickEventStream = env.readTextFile("dataset/AdClickLog.csv")
                .map( line -> {
